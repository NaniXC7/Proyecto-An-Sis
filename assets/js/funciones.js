        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response != 'error') {
                    ...
                    setTimeout(() => {
                        window.location = 'mesas.php?id_sucursal=' + id_sala + '&cajas=' + res.mensaje;
                    }, 1500);
                } else {
                    Swal.fire({
                        position: 'top-end',
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response != 'error') {
                    ...
                    setTimeout(() => {
                        window.location = 'mesas.php?sucursal_id=' + id_sala + '&cajas=' + res.mensaje;
                    }, 1500);
                } else {
                    Swal.fire({
                        position: 'top-end',
