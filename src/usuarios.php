        ...
        if (empty($id)) {
            ...
            if (empty($pass)) {
                ...
                if ($result > 0) {
                    ...
                    $query_insert = mysqli_query($conexion, "INSERT INTO `usuarios` (`nombre`, `correo`, `pass`, `sucursal_id`, `rol`, `estado`) VALUES ('$nombre', '$correo', '$pass', '$sucursal', '$rol', '1');");
                    if ($query_insert) {
    ...
    <table class="table table-hover table-striped table-bordered mt-2" id="tbl">
        ...
        <tbody>
            ...
            $query = mysqli_query($conexion, "SELECT u.id, u.nombre, u.correo, s.direccion, u.rol, u.estado FROM usuarios u 
                                            inner join sucursal s on u.sucursal_id = s.id WHERE u.estado = 1");
